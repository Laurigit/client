tabItem(tabName = "tab_LifeCounter",
        ...
        #  fluidRow(  verbatimTextOutput("results")),
          tabBox(id = "lifes_or_waiting", title = NULL, width = 12, height = "300px",
                 tabPanel(value = "chartti2", title = NULL,
                    fluidRow(plotOutput(outputId = "lifeChart", height = "280px"))),
                 tabPanel(value = "waiting2", title = NULL,
                          fluidRow(img(src="waiting.gif", align = "left",height='280px',width='800px')))),
